    ...
    <div class="invest_item">
        ...
        <div class="invest_panel">
            <p class="text">剩余金额：${item.itemAccount-item.itemOngoingAccount}元</p>
             <#if userInfo??>
                 <p class="text left_account"><span id="ye"
                                                    data-value=${busAccount.usable?c}>账户余额：${busAccount.usable}元</span>
            ...
            <p class="input_wrap clear" style="margin-top:-12px;">
                <#if  userInfo??>
                    <#if item.itemStatus ==1>
                         <a href="javascript:void(0)"><input class='invest_button fl'
                                                             style="background: #c9c9c9;cursor: default" type="button"
                                                             value="即将开放"></a>
                    <#elseif  item.itemStatus==10>
                            <a href="javascript:void(0)"><input class='invest_button fl' onclick="doInvest()"
                                                                type="button" value="立即投资"></a>
                    ...
                    <#else>
                         <a href="javascript:void(0)">
                             <input class='invest_button fl' style="background: #c9c9c9;cursor: default" type="button"
                                    value="已还款">
                         </a>
        ...
        <div id="contents">
            <div class="tab_content">
                ...
                <div class="table_box">
                    <table class="table_base">
                        ...
                        <tr>
                            <td>姓&nbsp;&nbsp;&nbsp;&nbsp;名</td>
                            <td>${(loanUser.realname)!}</td>
                            <td>车型</td>
                            <td>${(busItemLoan.carType)!}</td>
                        </tr>
                        <tr>
                            <td>身份证号</td>
                            <td>${(loanUser.identifyCard)!}</td>
                            <td>上牌时间</td>
                            <td>
                      <#if busItemLoan??>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>公里数</td>
                            <td>${(busItemLoan.kilometers)!"0"}万公里</td>
                        </tr>
                        <tr>
                            <td>首付金额</td>
                            <td>${(busItemLoan.firstPayAmount)!""}元</td>
                            <td>评估价</td>
                            <td>${(busItemLoan.assessPrice)!}元</td>
                        </tr>
                ...
                <div class="lunbo_wrap">
                    ...
                    <#--<div class="over_hidden">
                        ...
                        <#if pics??>
                            <#list pics as pic>
                                <li style="background-image: url(${pic.picturePath})" onclick="picTab()"
                                    data-url="${pic.picturePath}"></li>
                            </#list>
                        </#if>
            ...
            <div class="tab_content" >
                <table class="record">
                    <thead>
                    <tr>
                        <th width="400">投资用户</th>
                        <th>投资金额（元）</th>
                        <th width="400">投资时间</th>
                    </tr>
                    </thead>
                    <tbody id="recordList">
                    <tr>
