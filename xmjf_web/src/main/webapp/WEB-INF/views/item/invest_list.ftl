    ...
    <div class="contain">
        ...
        <div class="header_button">
            <div id="noUserId" style="width:142px;float: right">
                <a href="http://localhost:9999/user/toLoginPage"><input class="btn register" id="loginPage"
                                                                        type="button" value="登录"></a>
                <a href="http://localhost:9999/user/toRegisterPage"><input class="btn register" id="registerPage"
