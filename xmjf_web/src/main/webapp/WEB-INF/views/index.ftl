    ...
    <div class="banner">
        <ul class="pic_area">
            <a href="javascript:void(0)">
                <li style="background-image: url(${ctx}/img/item/1506490323436.jpg)"></li>
            </a>
            <a href="javascript:void(0)">
                <li style="background-image: url(${ctx}/img/item/1508931304000.png)"></li>
            </a>
        </ul>
        ...
        <div class="right_part">
            ...
            <div class="box-warp">
                <div class="flipper">
                    ...
                    <#else>
                        <div style="width:100%;">
                            <img src="/img/appqrcode.png" alt="" height='285' width='285'
